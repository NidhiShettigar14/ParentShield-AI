      ...
      <div className="container mx-auto px-4">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-1 px-3 py-2 rounded-lg transition-all duration-200 hover:scale-105 ${
                    isActive 
                      ? `font-semibold ${isDark ? 'bg-blue-900/30 text-blue-400' : 'bg-blue-100 text-blue-600'}` 
        ...
        {isMenuOpen && (
          ...
          >
            ...
            {/* Mobile Social Links */}
            <div className="flex items-center justify-center space-x-4 mt-6 pt-4 border-t" style={{ borderColor: colors.border.primary }}>
